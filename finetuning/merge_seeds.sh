...
source_dir="/media/leon/Samsung_T5/Uni/good_practices_ml/finetuning/runs/all_seeds"
destination_dir="/media/leon/Samsung_T5/Uni/good_practices_ml/finetuning/runs/merged_seeeds"
